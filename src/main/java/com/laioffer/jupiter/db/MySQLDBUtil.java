...
public class MySQLDBUtil {
    private static final String INSTANCE = "encoresproject-instance.cih5mt66tfjj.us-east-2.rds.amazonaws.com";
    private static final String PORT_NUM = "3306";
    private static final String DB_NAME = "encores_jupiter";
